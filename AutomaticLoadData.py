...
def LoadSineWaveData(station,run,pedFile,channel,kPed,kTime,kVolt):
    ...
    test = ROOT.TFile.Open(data_directory+"run00"+str(run)+"/event00"+str(run)+".root")
    ...
    #print(t,all_volts)
    np.save("data/SavedCalibData/time_"+str(run)+"_"+str(channel)+str(kPed)+str(kTime)+str(kVolt)+".npy",all_t)
    np.save("data/SavedCalibData/volts_"+str(run)+"_"+str(channel)+str(kPed)+str(kTime)+str(kVolt)+".npy",all_volts)
    np.save("data/SavedCalibData/blocks_"+str(run)+"_"+str(channel)+str(kPed)+str(kTime)+str(kVolt)+".npy",all_blocks)
